...
# change here
EVALUATION_AXIS=0   # 0 / 1 / 2
MODEL=cnn             # 0 / 1 / 2 / ave / cnn / 3T
...
if [[ "$MODEL" == "0" ]]; then
  ...
  MODEL_NAME="3T"
  GEN_DIR="${BIG_PATH}to_seg/${MODEL_NAME}"
  METRICS_CSV="${BIG_PATH}to_seg/3T_baseline/${MODEL_NAME}_lpips_brain_2d_sliceaxis_${SLICE_AXIS}.csv"
