...
PATH_MODEL="${BIG_PATH}Unet/results/unet_test12/trial1/my_unet.pt" # change trial here
PATH_SETTINGS="${BIG_PATH}Unet/results/unet_test12/trial1/params.txt" # change trial here
...
OUT_DIR="${BIG_PATH}to_seg/test12/${TAG}"
METRICS_CSV="${BIG_PATH}to_seg/test12/metrics_${TAG}.csv"
