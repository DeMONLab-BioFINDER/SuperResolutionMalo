...
n_trial = 2 #create a folder "resultsUnet" with folders "triali" where i=n_trial to save loss curves, "params.txt"  saves the settings###############
...
"size_batch" : 32, #reduce for RAM limitations, increase for less noise#######################
...
"test_size" : 13, 
"train_size"  : 123,
"n_slices" : 224, #########################coronal290 axial244 sagittal224 
"c_dim" : 1, #Dimension of the context
"slice_dim" : 2, #Dimension along which to divide the image in slices##########coronal0 axial1 sagittal2
"slice_size" : (288,242), #Image of the input and output images, before padding##########coronal(242 222) axial(288 222) sagittal(288 242)
...
info = pd.read_csv(data_dir+"patient_info_anon_2"+".csv")########## 012
